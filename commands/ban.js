exports.run = (client, msg, args, content, cooldown, command, Discord, config, request) => {
    ...
    var banTime = new Date().toLocaleString("en-US", {timeZone: "Asia/Kolkata", timeZoneName: "short", weekday: "short", month: "long", day: "2-digit", year: "numeric", hour: '2-digit', minute:'2-digit'});
    
    if (!msg.member.roles.find("name","✦ —————•Moderator•————— ✦","OWNER","✦ ——————•   Dev   •—————— ✦","✦ ——————• Admin •————— ✦","✦ —————• Co - Admin •———— ✦")) {
